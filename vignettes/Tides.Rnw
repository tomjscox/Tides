...
plot(waterlevels$time,waterlevels$h,ylab="water level [cmTAW]", xlab="time", type="l") # changed units to cm TAW instead of mTAW
...
plot(TidalCharacteristics(waterlevels, hoffset=3))
